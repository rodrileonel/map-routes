...
//
//     final coordsInfoResponse = coordsInfoResponseFromJson(jsonString);

import 'dart:convert';

CoordsInfoResponse coordsInfoResponseFromJson(String str) => CoordsInfoResponse.fromJson(json.decode(str));

String coordsInfoResponseToJson(CoordsInfoResponse data) => json.encode(data.toJson());

class CoordsInfoResponse {
    CoordsInfoResponse({
        this.type,
        this.query,
        this.features,
    ...
    factory CoordsInfoResponse.fromJson(Map<String, dynamic> json) => CoordsInfoResponse(
        type: json["type"],
